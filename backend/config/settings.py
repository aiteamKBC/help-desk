...
SUPPORT_CHAT_PROVIDER = (get_env("SUPPORT_CHAT_PROVIDER", "n8n") or "n8n").strip().lower()
...
COVERAGE_TICKET_WEBHOOK_SECRET = get_env(
    "N8N_COVERAGE_TICKET_WEBHOOK_SECRET",
    get_env("N8N_COVERAGE_OPERATIONS_WEBHOOK_SECRET", ""),
)
COVERAGE_SLA_WEBHOOK_URL = get_env(
    "N8N_COVERAGE_SLA_WEBHOOK_URL",
    get_env("N8N_COVERAGE_SLA_ALERTS_WEBHOOK_URL", COVERAGE_TICKET_WEBHOOK_URL),
)
...
APTEM_AUTO_EXTRACTING_DATABASE_URL = (
    get_env("APTEM_AUTO_EXTRACTING_DATABASE_URL")
    or get_env("APTEM_AUTO_EXTRATING_DATABASE_URL")
    or get_env("Aptem_auto_extrating_DATABASE")
)
...
SUPPORT_SESSION_BUFFER_MINUTES = max(int(get_env("SUPPORT_SESSION_BUFFER_MINUTES", "0") or "0"), 0)
